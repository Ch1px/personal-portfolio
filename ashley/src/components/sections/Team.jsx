                        ...
                        <div className="col-lg-6">
                            <div className="mil-team-list">
                                ...
                                <div className="row mil-mb-60">
                                    {/* Note above the image, aligned to the right */}
                                    <div className="mil-note" style={{ textAlign: 'right', marginBottom: '30px' }}>
                                        <p dangerouslySetInnerHTML={{ __html: Data.note }} />
                                    </div>
                                    <div className="col-sm-12"> {/* Full width for the single image */}
                                                        ...
                                                        <ul className="mil-social-icons mil-center">
                                                            {item.social.map((social, key2) => (
                                                                <li key={`services1-item${key}-social-${key2}`}>
                                                                    <a href={social.link} target="_blank" className="social-icon" title={social.title}>

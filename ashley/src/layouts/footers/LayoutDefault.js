                    ...
                    <div className="col-md-7 col-lg-6">
                        ...
                        <div className="row justify-content-between">
                            ...
                            <div className="col-md-6 col-lg-5 mil-mb-60">
                                ...
                                <h6 className="mil-muted mil-up mil-mb-30">London</h6>
                            ...
                            <div className="col-md-6 col-lg-5 mil-mb-60">
                                ...
                                <h6 className="mil-muted mil-up mil-mb-30">Yorkshire</h6>

                                <p className="mil-light-soft mil-up">Boroughbridge, Yorkshire <span className="mil-no-wrap">+44 7534 525276</span></p>
